...
int range(int pos)
{
 ...
 if(current_distance > 0 && current_distance < 25)
   {
     Serial.print("B");
     if(pos==90){  // pos = 90 => forward direction
     backward();
     delay(500);}
     if(pos < 90){ // pos < 90 => left direction
     backward_right();
     delay(500);}
     if(pos > 90){ // pos > 90 => right direction
     backward_left();
     delay(500);}
